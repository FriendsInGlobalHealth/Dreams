...
'deficiencia','house_sustainer','married_before','pregant_or_breastfeed','employed','tested_hiv','vbg_exploracao_sexual','vbg_migrante_trafico','vbg_sexual_activa','vbg_relacao_multipla','vbg_vitima','vbg_vitima_trafico','alcohol_drugs_use','sti_history'], 'safe'],
        ];
    }
...
$query = Beneficiarios::find()->where(['emp_status'=>1]);
	    ...
	    ->andFilterWhere(['like', 'criado_em', $this->criado_em])
            ...
            ->andFilterWhere(['like', 'alcohol_drugs_use', $this->alcohol_drugs_use])
            ->andFilterWhere(['like', 'sti_history', $this->sti_history]);
